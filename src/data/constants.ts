export const towns = [
  { name: 'Wiggins', slug: 'wiggins', businesses: 0 },
  { name: 'McHenry', slug: 'mchenry', businesses: 0 },
  { name: 'Perkinston', slug: 'perkinston', businesses: 0 },
  { name: 'Bond', slug: 'bond', businesses: 0 },
  { name: 'Ramsey Springs', slug: 'ramsey-springs', businesses: 0 },
  { name: 'Saucier', slug: 'saucier', businesses: 0 },
];
